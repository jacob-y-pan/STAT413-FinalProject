...
Now let's calculate the Mahalanobis distance for each point in the training set, and plot the data with the Mahalanobis distance ellipses. Note that for each plot we make, an x is marked on points considered outliers.
